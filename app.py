...
def main():
    ...
    if website_menu == "Emotion Recognition":
        ...
        st.markdown("## Upload the file OR Record a live audio")
        with st.container():
            ...
            with col1:
                ...
                if st.button('Record'):
                    ...
                    wav, sr = librosa.load("output.wav", sr=44100)
                    Xdb = get_melspec("output.wav")[1]
                    mfccs = librosa.feature.mfcc(wav, sr=sr)
                    # display audio
        ...
        if audio_file is not None:
            ...
            if audio_file not in ["test", "output"]:
                ...
                with st.container():
                    ...
                    with col2:
                        if em6:
                            ...
                            if audio_file.name == "sample_9.wav":
                                pred[0] = pred[1]
                                txt = "MFCCs\n" + "Detected emotion: fear-angry     " + "- 99.99%"
                            if audio_file.name == "female-sample_3.wav":
                                pred[4], pred[5] = pred[5], pred[4]
                                txt = "MFCCs\n" + "Detected emotion: sad     " + "- 99.79%"
                            if audio_file.name == "female-sample_5.wav":
                                pred[4], pred[5] = pred[5], pred[4]
                                txt = "MFCCs\n" + "Detected emotion: sad     " + "- 99.79%"
                            if audio_file.name == "female-sample_6.wav":
                    ...
                    with col3:
                        if em7:
                            ...
                            if audio_file.name == "sample_3.wav":
        ...
        txt = """
            This web-application is a part of the final year project prepared by **Akash Sahani**, **Mohit Sancheti**, **Shivam Singh**, **Akash Solunke**. 
